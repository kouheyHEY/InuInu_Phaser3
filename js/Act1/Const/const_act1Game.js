...
// 敵の最高数
CONST_ACT1.ENEMYNUM_MAX = 1000;
// 敵の数の増加間隔（フレーム）
CONST_ACT1.ENEMYNUM_INC_FRAME = COMMON.FPS * 0.25;
// 敵の生成時のプレイヤーとの最低距離
...
// レベルアップに必要なSPの増加量
CONST_ACT1.SP_LVUP_INC_RATE = 1.15;
...
// レベル上限
CONST_ACT1.PLAYER_LEVEL_MAX = 20;
// レベルアップ時のエフェクト
CONST_ACT1.EFFECT_LEVELUP = {
    TIME: 400,
    TRANS_DIST: 48,
}
